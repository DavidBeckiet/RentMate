export const applicationErrorStatus = {
  ...
  GOOGLE_ONBOARDING_REQUIRED: 401,
  GOOGLE_ACCOUNT_NOT_REGISTERED: 401,
  GOOGLE_ACCOUNT_EXISTS: 409,
  ROOMMATE_OPEN_REQUEST_EXISTS: 409,
  ROOMMATE_ACTIVE_CONNECTION_EXISTS: 409,
  ROOMMATE_CANDIDATE_OPEN_REQUEST: 409,
  ROOMMATE_REQUEST_NOT_OPEN: 409,
  ROOMMATE_REQUEST_EXPIRED: 409,
  ROOMMATE_INTEREST_NOT_PENDING: 409,
  ROOMMATE_LISTING_INELIGIBLE: 409,
  ROOMMATE_PENDING_INTEREST_LIMIT: 409,
