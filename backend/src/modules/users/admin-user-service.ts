import type { TransactionRunner } from "../listings/listing-create-service.js";
...
import type { AdminUserActivationInput, AdminUserCollectionQuery } from "./admin-user-validation.js";
