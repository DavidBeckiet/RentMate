...
import { ApplicationError, createValidationError } from "../../shared/errors/application-error.js";
...
import type { CreateListingDraftInput } from "./listing-create-validation.js";
import { createOwnerListing, type OwnerListing } from "./owner-listing-mapper.js";
