...
describe("RM-029 application isolation", () => {
  it("contains exactly 40 listings files, one integration client, and eleven routes", async () => {
    ...
    expect(routes).not.toMatch(/router\.put|images\/:imageId|images\/order|replace|bulk|geocod|favorite|admin/i);
  });
